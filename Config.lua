...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Emóták',
        ['danceemotes'] = "🕺 Táncos Emóták",
        ['propemotes'] = "📦 Tárgyas Emóták",
        ['favoriteemotes'] = "🌟 Kedvenc Emóták",
        ['favoriteinfo'] = "Válaszd Ki a Kedvenc Emótádat!.",
        ['rfavorite'] = "Kedvenc Emóta Visszaállítása",
        ...
        ['cancelemote'] = "Emóta befejezése",
        ['cancelemoteinfo'] = "~r~X~w~ Emóta abbahagyása.",
        ['walkingstyles'] = "Sétálási Stílusok",
        ['resetdef'] = "Visszaállítás az alapra!",
        ['normalreset'] = "Visszaállítás",
        ['moods'] = "Arckifejezések",
        ['infoupdate'] = "Információk",
        ['infoupdateav'] = "Information (Frissitések)",
        ...
        ['notvaliddance'] = "Nincs Ilyen Tánc!.",
        ['notvalidemote'] = "Nincs Ilyen Emóta!",
        ['nocancel'] = "Nincs Mit Abbahagyni.",
        ['maleonly'] = "This emote is male only, sorry!",
        ['emotemenucmd'] = "Do /emotemenu for a menu.",
        ['shareemotes'] = "👫 Közös Emóták",
        ['shareemotesinfo'] = "Invite a nearby person to emote",
        ['sharedanceemotes'] = "🕺 Közös Táncok",
        ['notvalidsharedemote'] = "Nincs ilyen közös emóta!.",
        ['sentrequestto'] = "Elkülted a felhívást ~y~",
        ['nobodyclose'] = "Nobody ~r~close~w~ enough.",
        ['doyouwanna'] = "~y~Y~w~ Az Elfogadáshoz, ~r~L~w~ Az Elutasításhoz! (~g~",
        ['refuseemote'] = "Emóta Visszautasítva!.",
        ['makenearby'] = "Nincsa a közeledbe Player!",
        ...
        ['keybinds'] = "🔢 Gombra állítás",
        ['keybindsinfo'] = "Használ"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
